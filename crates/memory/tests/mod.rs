...
#[cfg(all(not(feature = "minimal"), feature = "persistence", feature = "legacy-tests"))]
mod persistence_suites {
    include!("./test_vector_store.rs");
    include!("./test_cache_migration.rs");
}

#[cfg(all(not(feature = "minimal"), feature = "rayon", feature = "legacy-tests"))]
mod vector_suites {
    include!("./test_batch_optimized.rs");
}

#[cfg(all(not(feature = "minimal"), feature = "gpu-acceleration", feature = "legacy-tests"))]
mod gpu_suites {
