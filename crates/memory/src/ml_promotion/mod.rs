...
pub use algorithms::{AlgorithmFactory, FrequencyAlgorithm, HybridAlgorithm, SemanticAlgorithm};
pub use coordinator::{CoordinatorInfo, PromotionCoordinator, PromotionCoordinatorBuilder};
...
mod tests {
    ...
    fn test_factory_configs() {
        ...
        assert!(
            dev_rules.min_repromotion_interval_hours < prod_rules.min_repromotion_interval_hours
        );
