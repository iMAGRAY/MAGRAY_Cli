...
impl DIMemoryServiceMigrationFacade {
    ...
    pub async fn batch_insert(
        ...
        Ok(crate::service_di::BatchInsertResult {
            inserted,
            failed,
            errors,
    ...
    pub async fn batch_search(
        ...
        Ok(crate::service_di::BatchSearchResult {
            queries,
            results,
            total_time_ms: start_time.elapsed().as_millis() as u64,
        })
    ...
    pub async fn run_promotion(&self) -> Result<PromotionStats> {
        ...
        if let Some(promotion_engine) = self
            .container
            .try_resolve::<crate::promotion::PromotionEngine>()
        {
    ...
    pub async fn check_health(&self) -> Result<SystemHealthStatus> {
        if let Some(health_monitor) = self
            .container
            .try_resolve::<Arc<crate::health::HealthMonitor>>()
        {
