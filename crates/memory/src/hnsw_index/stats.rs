...
impl HnswStats {
    ...
    pub fn record_search(&self, duration: Duration, distance_calcs: u64) {
        ...
        self.total_distance_calculations
            .fetch_add(distance_calcs, Ordering::Relaxed);
    ...
    pub fn record_insertion(&self, count: u64, duration: Duration, is_parallel: bool) {
        ...
        if is_parallel {
            self.total_parallel_insert_time_us
                .fetch_add(duration_us, Ordering::Relaxed);
            self.parallel_batches_processed
