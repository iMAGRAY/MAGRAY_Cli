...
pub fn debug_simd_performance() {
    ...
    #[cfg(target_arch = "x86_64")]
    {
        ...
        println!("  Accuracy diff: {:.8}", (scalar_result - result1).abs() / ITERATIONS as f32);
        ...
        println!("  Accuracy diff: {:.8}", (scalar_result - result2).abs() / ITERATIONS as f32);
        ...
        if is_x86_feature_detected!("fma") {
            ...
            println!("  Accuracy diff: {:.8}", (scalar_result - result3).abs() / ITERATIONS as f32);
        }
        ...
        if DIMENSION % 16 == 0 {
            ...
            println!("  Accuracy diff: {:.8}", (scalar_result - result4).abs() / ITERATIONS as f32);
        }
        ...
        println!("  Accuracy diff: {:.8}", (scalar_result - result5).abs() / ITERATIONS as f32);
    }
