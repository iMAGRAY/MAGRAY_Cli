...
impl MigrationManager {
    ...
    pub async fn migrate(&self) -> Result<()> {
        ...
        if current_version < CURRENT_SCHEMA_VERSION {
            info!("Начинаем миграцию с версии {} на {}", current_version, CURRENT_SCHEMA_VERSION);
    ...
    async fn migrate_v0_to_v1(&self) -> Result<()> {
        ...
        info!("Очищено {} некорректных записей, {} ошибок", cleaned_count, error_count);
    ...
    async fn migrate_v1_to_v2(&self) -> Result<()> {
        ...
        info!("Мигрировано {} записей, пропущено {}", migrated_count, skipped_count);
