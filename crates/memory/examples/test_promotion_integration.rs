...
async fn main() -> Result<()> {
    ...
    info!("🚀 Тест интеграции PromotionEngine в MemoryService");
    info!("===========================================================\n");
    ...
    // Создаем MemoryService с интегрированным PromotionEngine
    println!("\n🔧 Создание MemoryService с PromotionEngine...");
    let memory_service = MemoryService::new(memory_config).await?;
    println!("✅ MemoryService с интегрированным PromotionEngine создан!");
    ...
    let optimized_stats = memory_service.run_promotion_cycle().await?;
    ...
    println!("========================");
    println!("  ✅ PromotionEngine успешно интегрирован в MemoryService");
    println!("  ✅ Time-based индексы работают в production");
    ...
    if integration_score >= 90 {
        println!("\n🎉 ИНТЕГРАЦИЯ PROMOTIONENGINE ЗАВЕРШЕНА!");
