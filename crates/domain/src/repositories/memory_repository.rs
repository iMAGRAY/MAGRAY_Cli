...
pub trait MemoryRepository: Send + Sync {
    ...
    async fn find_promotion_candidates(&self, from_layer: LayerType) -> DomainResult<Vec<MemoryRecord>>;
...
pub trait MemoryMetadataRepository: Send + Sync {
    ...
    async fn find_by_access_pattern(&self, pattern_type: AccessPatternType) -> DomainResult<Vec<RecordId>>;
